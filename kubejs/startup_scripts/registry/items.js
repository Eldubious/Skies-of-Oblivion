StartupEvents.registry('item', event => {
    ...
    // Colored Fire Bricks & Fire Clay Blends
    ...
    for (let color of dye_colors) {
        ...
        event.create(`oblivion:${color}_fire_clay_blend`)
            .translationKey(`item.oblivion.${color}_fire_clay_blend`)
            .tag('oblivion:fire_clay_blends')
    }
